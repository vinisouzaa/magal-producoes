...
<table border="0" id="tabela" data-corner="top 8px">
  <tr>
    <td align="center" class="td_titulo">
      <span class="titulo1">Listando Parceiros</span>
    </td>
  </tr>
</table>
...
<table  border="0" cellspacing="10" id="tabela2">
  ...
  <tr bgcolor="#CCCCCC">
    ...
    <td width="119" align="center" class="td_titulo2">Link</td>
    <td width="48" align="center" class="td_titulo2">Imagem</td>
  </tr>
  
  <?php
  
  $sql = 'SELECT * FROM parceiros ORDER BY id DESC LIMIT '.$inicio.','.$maximo.'';
  ...
  <tr bgcolor="#FFFFFF">
    ...
    <a href="?pg=op-parceiros&id=<?php echo $dados['id']; ?>&op=alterar" 
       title='Alterar Parceiro: "<?php echo $dados['link']; ?>"'>
    ...
    <td align="center">
      ...
      <a href="?pg=op-parceiros&id=<?php echo $dados['id']; ?>&op=excluir" 
         onclick="certeza=confirm('Tem Certeza que deseja excluir?'); if 
         (certeza==1){ return true; }else{ return false; }" title='Excluir Parceiro: "<?php echo $dados['link']; ?>"'>
        <img src="images/del.png" border="0"  />
      </a>
      
    </td>
    <td align="center" class="td-texto"><?php echo $dados['link']; ?></td>
    <td align="center">
      <a href="../images/parceiros/<?php echo $dados['imagem']; ?>" target="_blank" class="lightbox" title="Ver imagem ampliada">
        <img src="timthumb.php?src=../images/parceiros/<?php echo $dados['imagem']; ?>&w=140&h=110&zc=1&q=100" border="0" />
      </a>
    </td>
  </tr>
