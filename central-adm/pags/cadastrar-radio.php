...
<table border="0" id="tabela" data-corner="top 8px">
  ...
  <tr>
    <td align="center" class="td_titulo">
      <span class="titulo1">Cadastrar Rádio</span>
    </td>
  </tr>
...
<table border="0" id="tabela2">
  ...
  <tr>
    <td width="14%" height="47" align="center" class="td_topico">Rádio:</td>
    <td width="86%" align="left" class="td_input">
      <input type="text" name="radio" class="input" />
    </td>
  </tr>
  <tr>
    <td width="14%" height="47" align="center" class="td_topico">Cidade:</td>
    <td width="86%" align="left" class="td_input">
      <input type="text" name="cidade" class="input" />
    </td>
  </tr>
  <tr>
    <td width="14%" height="47" align="center" class="td_topico">Frequencia:</td>
    <td width="86%" align="left" class="td_input">
      <input type="text" name="frequencia" class="input" />
    </td>
  </tr>
  <tr>
    <td width="14%" height="47" align="center" class="td_topico">Site:</td>
    <td width="86%" align="left" class="td_input">
      <input type="text" name="site" class="input" />
    </td>
  </tr>
  <tr>
    <td height="62" align="center" class="td_topico">Logo:</td>
...
$sql  = 'INSERT INTO radios (nome, cidade, frequencia, site, imagem) VALUES (:nome, :cidade, :frequencia, :site, :imagem)';
  ...
  echo "<div class='msg certo'><span>Rádio cadastrado com sucesso!</span></div>";
